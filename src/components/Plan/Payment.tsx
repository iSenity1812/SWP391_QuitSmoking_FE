...
import { Check, Crown, Star, CreditCard, Shield, Smartphone, Building, ChevronLeft, Sparkles } from "lucide-react"
...
export const PaymentFlow: React.FC<PaymentFlowProps> = ({ onSelectPlan, onBack }) => {
    ...
    const handlePaymentSubmit = () => {
        ...
        setTimeout(() => {
            onSelectPlan("premium", selectedPlan?.duration)
        }, 2000)
    }
                ...
                {step === "plan-selection" && (
                    ...
                    >
                        <div className="text-center space-y-2">
                            <h2 className="text-3xl font-bold text-slate-800 dark:text-white">Chọn Gói Dịch Vụ</h2>
                            <p className="text-slate-600 dark:text-slate-300">
                                Lựa chọn gói phù hợp để bắt đầu hành trình cai thuốc của bạn
                            </p>
                        </div>
