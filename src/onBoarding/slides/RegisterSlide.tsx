...
import { ChevronLeft, User, Lock, Eye, EyeOff, ArrowRight, Check, X } from "lucide-react"
...
export const RegisterSlide: React.FC<RegisterSlideProps> = ({ onSuccess, onBack, onSwitchToLogin }) => {
    ...
    const getPasswordStrength = () => {
        ...
        if (passedChecks <= 3) return { text: "Medium", color: "text-yellow-500" }
        if (passedChecks <= 4) return { text: "Good", color: "text-blue-500" }
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-8 left-8 w-16 h-16 bg-green-200/40 rounded-full blur-sm"></div>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">Fresh Start</h1>
                ...
                <div className="w-full max-w-md bg-white rounded-3xl border-2 border-emerald-400 p-8 shadow-sm">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">Join us on your journey to quit smoking</p>
                    </div>
                                ...
                                <div className="mt-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-xs text-gray-500">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span className={passwordChecks.length ? "text-green-600" : ""}>8+ characters</span>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span className={passwordChecks.uppercase ? "text-green-600" : ""}>Uppercase</span>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span className={passwordChecks.lowercase ? "text-green-600" : ""}>Lowercase</span>
                                        </div>
                                        <div className="flex items-center gap-1">
                                        ...
                                        <div className="flex items-center gap-1 col-span-2">
                                            ...
                                            <span className={passwordChecks.special ? "text-green-600" : ""}>Special char</span>
                                        </div>
                                    </div>
                                </div>
                            )}
