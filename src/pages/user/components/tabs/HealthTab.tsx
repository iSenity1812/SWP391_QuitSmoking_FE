        ...
        return (
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Đang tải dữ liệu sức khỏe...</p>
                </div>
            ...
            {metrics.length > 0 && (
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Các chỉ số sức khỏe được cải thiện theo thời gian</CardDescription>
                    </CardHeader>
                    <CardContent>
