...
export function BookingTab({ user }: BookingTabProps) {
    ...
    const checkSubscriptionStatus = () => {
        try {
            ...
            if (storedSubscription) {
                ...
                // Check user data subscription as fallback
    ...
    // Premium plans for subscription
    const premiumPlans = [
        {
            id: "premium-monthly",
    ...
    return (
        <div className="space-y-6">
            ...
            {!isPremium ? (
                ...
                <Card className={`bg-gradient-to-r ${getPremiumStatusColor()} text-white`}>
                    <CardContent className="p-6">
            ...
            {/* Coaches Section */}
            <div>
                <h3 className="text-xl font-semibold mb-4">Chuyên gia tư vấn</h3>
                        ...
                        >
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <Button className="w-full" disabled={!isPremium}>
                                    {isPremium ? "Đặt lịch" : "Cần Premium"}
                                </Button>
                            </CardContent>
                        </Card>
                    ))}
            ...
            {/* Appointments Section - Only show for premium users */}
            {isPremium && (
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-semibold">Lịch hẹn của bạn</h3>
                                ...
                                <CardContent className="p-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h4 className="font-medium">{appointment.coachName}</h4>
                        ...
                        {appointments.length === 0 && (
                            <Card>
                                <CardContent className="p-8 text-center">
                                    ...
                                    <h4 className="font-medium mb-2">Chưa có lịch hẹn nào</h4>
                                    <p className="text-slate-600 dark:text-slate-300 mb-4">
                                        Đặt lịch với chuyên gia để bắt đầu hành trình cai thuốc
                                    </p>
                                    <Button onClick={() => setShowBookingDialog(true)}>Đặt lịch ngay</Button>
                                </CardContent>
                            </Card>
                        )}
                    </div>
