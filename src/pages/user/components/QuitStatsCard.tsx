    ...
    return (
        <Card className="w-full">
            <CardHeader>
                ...
                <CardDescription>
                    Theo dõi tiến trình cai thuốc của bạn (số liệu đồng bộ với thành tựu)
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {/* Điếu đã tránh - chuyển lên khung màu xanh dương */}
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-blue-700">Điếu Đã Tránh</p>
                                <p className="text-2xl font-bold text-blue-900">
                                    {stats.cigarettesAvoided.toLocaleString()}
                                </p>
                                <p className="text-xs text-blue-600 mt-1">điếu</p>
                            </div>
                    ...
                    {/* Tiền tiết kiệm - chuyển lên khung màu tím */}
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg border border-purple-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-purple-700">Tiền Tiết Kiệm</p>
                    ...
                    {/* Ngày không hút - chuyển sang khung màu vàng */}
                    <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-4 rounded-lg border border-yellow-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-yellow-700">Ngày Không Hút</p>
                                <p className="text-2xl font-bold text-yellow-900">
                                    {stats.daysWithoutSmoking}
                                </p>
                                <p className="text-xs text-yellow-600 mt-1">ngày</p>
                            </div>
                ...
                {/* Thông tin bổ sung - tính toán dựa trên số liệu đã đồng bộ */}
