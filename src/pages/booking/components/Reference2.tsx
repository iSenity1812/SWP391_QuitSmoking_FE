            ...
            {specialtyOptions.map((specialty) => (
              <div key={specialty.key} className="flex items-start space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleSpecialtyChange(specialty.key, checked as boolean)}
...
function CoachSelectionModal({ isOpen, onClose, coaches, timeSlot, date, onBook }: CoachSelectionModalProps) {
            ...
            <Popover open={showPopover} onOpenChange={setShowPopover}>
              ...
              <PopoverContent className="w-80 p-0" align="start">
                <div className="p-4 border-b border-slate-200">
                  <h4 className="font-medium text-slate-900">Coach có sẵn</h4>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between">
                            <span className="text-sm font-medium text-slate-900">{coach.fullName}</span>
                          </div>
                ...
                {coaches.length > 5 && (
                  <div className="p-3 border-t border-slate-200">
                    ...
                    >
                      Xem tất cả {coaches.length} coach
                    </Button>
                  </div>
                )}
              </PopoverContent>
