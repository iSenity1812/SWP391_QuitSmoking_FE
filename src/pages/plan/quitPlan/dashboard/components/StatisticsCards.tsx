...
export function StatisticsCards({
    ...
    const getMoodAdvice = (moodVietnamese: string) => {
        ...
        if (['HAPPY', 'VERY_HAPPY', 'EXCITED', 'RELAXED', 'PEACEFUL', 'CONFIDENT', 'HOPEFUL', 'CONTENT', 'MOTIVATED', 'ENERGETIC', 'CALM'].includes(englishMood)) {
        ...
        if (['STRESSED', 'ANXIOUS', 'WORRIED', 'FRUSTRATED'].includes(englishMood)) {
        ...
        if (['SAD', 'VERY_SAD', 'DEPRESSED', 'DISAPPOINTED', 'DISCOURAGED', 'DOWN', 'UNHAPPY'].includes(englishMood)) {
        ...
        if (['TIRED', 'HUNGRY', 'UNCOMFORTABLE', 'UNSATISFIED'].includes(englishMood)) {
                    ...
                    <CardContent>
                        <div className="space-y-3 flex flex-col justify-around">
                            {isCravingStatsLoading ? (
                                ...
                                <>
                                    <h4 className="font-medium text-gray-800 mb-2">Tác nhân phổ biến nhất:</h4>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <div className="w-20 bg-gray-200 rounded-full h-2">
                                                        <div
                                                            ...
                                                            style={{
                                                                width: cravingStats.totalCravings > 0
                                                                    ? `${(item.count / cravingStats.totalCravings) * 100}%`
                                                                    : '0%'
                                                            }}
                                                        />
                                                    </div>
                                    ...
                                    <div className="mt-4 p-3 bg-orange-50 rounded-lg">
                                        <p className="text-sm text-orange-700">
                                            💡 <strong>Gợi ý:</strong> {cravingStats.commonSituations[0]?.count > 0
                                                ? <>
                                                    ...
                                                    . Hãy tránh hoặc chuẩn bị chiến lược đối phó với tình huống này.
                                                </>
                    ...
                    <CardContent>
                        <div className="space-y-3 flex flex-col justify-around">
                            {isCravingStatsLoading ? (
                                ...
                                <>
                                    <h4 className="font-medium text-gray-800 mb-2">Hoạt động theo bối cảnh:</h4>
                                    <div className="max-h-[200px] overflow-y-auto space-y-2">
                                    ...
                                    <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                                        <p className="text-sm text-blue-700">
                                            💡 <strong>Gợi ý:</strong> {cravingStats.commonCompanions[0]?.count > 0
                                                ? <>
                                                    Bạn thường hút/thèm thuốc nhất khi{" "}
                    ...
                    <CardContent>
                        <div className="space-y-3">
                            {isMoodStatsLoading ? (
                                ...
                                <>
                                    <h4 className="font-medium text-gray-800 mb-2">Tâm trạng phổ biến nhất:</h4>
                                    <div className="max-h-[200px] overflow-y-auto space-y-2">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <div className="w-20 bg-gray-200 rounded-full h-2">
                                                        <div
                                                            ...
                                                            style={{
                                                                width: moodStats.totalMoodRecords > 0
                                                                    ? `${(item.count / moodStats.totalMoodRecords) * 100}%`
                                                                    : '0%'
                                                            }}
                                                        />
                                                    </div>
                                    ...
                                    <div className="mt-4 p-3 bg-green-50 rounded-lg">
                                        <p className="text-sm text-green-700">
                                            💡 <strong>Gợi ý:</strong> {moodStats.commonMoods[0]?.count > 0
                                                ? (() => {
                                                    const topMood = moodStats.commonMoods[0].mood.toLowerCase()
                                                    return (
                                                        <>
